...
export const initialEnquiries = [
  {
    ...
    additional_notes: "Client requested full turnkey estimate including 4BHK floor plan, modular kitchen & terrace waterproofing."
  },
  {
    enquiry_id: "ENQ-2026-002",
    client_name: "Priya Venkatesh",
    client_phone: "+91 97892 11045",
    whatsapp_number: "+91 97892 11045",
    client_email: "priya.v@outlook.com",
    site_location: "Thindal, Erode",
    structure_type: "Residential House",
    structure_spec: "RCC Frame Structure (M30 Grade)",
    cement_brand: "Ambuja PPC (Premium)",
    steel_brand: "JSW Neosteel (Premium)",
    bricks_blocks_spec: "AAC Blocks (Lightweight)",
    flooring_spec: "Vitrified Tiles (Premium)",
    doors_spec: "Flush Doors (Teak Frame)",
    windows_spec: "Aluminium Windows (Powder Coated)",
  ...
  },
  {
    ...
    additional_notes: "Commercial office space with basement parking and elevator shaft."
  },
  {
    enquiry_id: "ENQ-2026-004",
    client_name: "Anand & Lakshmi Krishnan",
    client_phone: "+91 98940 54321",
    whatsapp_number: "+91 98940 54321",
    ...
    flooring_spec: "Vitrified Tiles (Premium)",
    doors_spec: "Teak Wood Doors (Premium)",
    windows_spec: "Teak Wood Windows (Classic)",
    plot_size: "35 x 50 (1750 sq. ft.)",
    builtup_area_sqft: 1800,
    number_of_floors: "G + 1 Floor",
    preferred_start_date: "2026-10-10",
    estimated_rate_per_sqft: "₹1,400",
    total_estimated_cost: 2520000,
    enquiry_date: "2026-09-20",
    lead_stage: "New Enquiry",
    additional_notes: "Existing 15-year old building renovation with 1st floor extension."
  },
  {
    enquiry_id: "ENQ-2026-005",
    client_name: "Dr. Vijaykumar M.",
    client_phone: "+91 98430 77112",
    whatsapp_number: "+91 98430 77112",
    ...
    steel_brand: "TATA Tiscon 550D (High Strength)",
    bricks_blocks_spec: "Red Bricks (Premium)",
    flooring_spec: "Italian Marble (Imported)",
    doors_spec: "Teak Wood Doors (Premium)",
    windows_spec: "UPVC Sliding Windows (Soundproof)",
    plot_size: "45 x 70 (3150 sq. ft.)",
    ...
    additional_notes: "Luxury contemporary villa with solar power roof integration."
  }
];
...
export const initialPayments = [
  ...
  },
  {
    ...
    payment_mode: "GPay",
    transaction_reference: "UPI/20260122/882103",
    notes: "Slab casting advance payout",
    entered_by: "Bala",
  ...
  },
  {
    ...
    payment_mode: "Cash",
    transaction_reference: "CASH-REC-1092",
    notes: "Renovation advance payment",
    entered_by: "Suriya prakash",
...
export const initialAppointments = [
  {
    ...
    additional_notes: "Client requested 3D laser scan and modular kitchen material samples demo.",
    status: "Scheduled"
  },
  {
    ...
    additional_notes: "Water leakage inspection needed on 2nd floor terrace slab.",
    status: "Scheduled"
  },
  {
    ...
    preferred_time_slot: "Evening (5:00 PM - 7:00 PM)",
    renovation_services: ["Full Home Renovation"],
    additional_notes: "Full site survey completed with mobile van unit.",
    status: "Completed"
  }
];
