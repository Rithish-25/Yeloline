  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', minHeight: 'calc(100vh - 120px)' }}>
      <div className="leads-header-row">
        <div>
          <h1 className="dashboard-title">Admin Master</h1>
          <p className="dashboard-subtitle">Admin master configuration and control panel</p>
        </div>
      </div>
      <div style={{
        flex: 1,
        ...
        <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', maxWidth: '400px', lineHeight: '1.5' }}>
          The Admin Master module is currently under development and will be available soon.
        </p>
      </div>
    </div>
  );
